...
- Пиксель-арт спрайты голов и перчаток пробовались и ОТКАТАНЫ: пользователь
  выбрал прежних «круглых» персонажей (векторные головы и перчатки). Код
  спрайтов есть в истории (коммиты «Голова — спрайт», «Перчатка — спрайт»,
  «Десять вариантов внешности») — если возвращать, то только по просьбе.
